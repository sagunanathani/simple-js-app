...
const searchForm = document.querySelector("form"),
  ...
  pokemonListContainer = document.querySelector(".pokemon-list");
function filterPokemonList() {
  let e = searchInput.value.trim().toLowerCase(),
    t = pokemonListContainer.querySelectorAll("li");
  t.forEach((t) => {
    let n = t.querySelector("button").textContent.toLowerCase();
    t.style.display = !e || n.includes(e) ? "block" : "none";
  });
}
...
searchForm.addEventListener("submit", function (e) {
  e.preventDefault(), filterPokemonList();
}),
